          ...
          {[
            {
              ...
              description: "Define how AI is used and whether PHI is involved.",
              direction: "top",
            },
            {
              title: "Vendor & Data Flow Review",
              description: "Identify third-party services, BAAs, and data exposure.",
              direction: "right",
            },
            {
            ...
            },
            {
              ...
              description: "View findings, citations, and remediation guidance.",
              direction: "bottom",
            },
          ].map((service, i) => (
